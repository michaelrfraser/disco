...
public class Warhead
{
	...
	{
		int[] values =
		    { OTHER, CARGO, FUEL_AIR_EXPLOSIVE, GLASS_BLADS, ONE_UM, FIVE_UM, TEN_UM,
		     HIGH_EXPLOSIVE, HE_PLASTIC, HE_INCENDIARY, HE_FRAGMENTATION, HE_ANTITANK, HE_BOMBLETS,
		     HE_SHAPED_CHARGE, HE_CONTINUOUS_ROD, HE_TUNGSTEN_BALL, HE_BLAST_FRAGMENTATION,
		     HE_STEERABLE_DARTS_WITH_HE, HE_DARTS, HE_FLECHETTES, HE_DIRECTED_FRAGMENTATION,
		     HE_SEMIARMOR_PIERCING, HE_SHAPED_CHARGE_FRAGMENTATION,
		     HE_SEMIARMOR_PIERCING_FRAGMENTATION, HE_HALLOW_CHARGE, HE_DOUBLE_HALLOW_CHARGE,
		     HE_GENERAL_PURPOSE, HE_BLAST_PENETRATOR, HE_ROD_PENETRATOR, HE_ANTIPERSONNEL, SMOKE,
		     ILLUMINATION, PRACTICE, KINETIC, MINES, NUCLEAR, NUCLEAR_IMT, CHEMICAL_GENERAL,
		     CHEMICAL_BLISTER_AGENT, HD, THICKENED_HD, DUSTY_HD, CHEMICAL_BLOOD_AGENT, AC, CK, CG,
		     CHEMICAL_NERVE_AGENT, VX, THICKENED_VX, DUSTY_VX, GA, THICKENED_GA, DUSTY_GA, GB,
		     THICKENED_GB, DUSTY_GB, GD, THICKENED_GD, DUSTY_GD, GF, THICKENED_GF, DUSTY_GF,
		     BIOLOGICAL, BIOLOGICAL_VIRUS, BIOLOGICAL_BACTERIA, BIOLOGICAL_RICKETTSIA,
		     BIOLOGICAL_GENETICALLY_MODIFIED_MICROORGANISMS, BIOLOGICAL_TOXIN };
		return values;
	}
